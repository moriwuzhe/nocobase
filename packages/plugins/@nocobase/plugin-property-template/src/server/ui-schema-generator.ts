      ...
      actions: {
        ...
        properties: {
          ...
          [uid()]: {
            ...
            'x-action-settings': { exportSettings: columnFields.map((f) => ({ dataIndex: [f] })) },
          },
          [uid()]: {
            type: 'void',
            title: '{{ t("Import") }}',
            ...
            'x-component': 'Action',
            'x-component-props': { icon: 'UploadOutlined' },
            'x-action-settings': { importSettings: { importColumns: columnFields.map((f) => ({ dataIndex: [f] })), explain: '' } },
          },
          [uid()]: {
            type: 'void',
            title: '{{ t("Delete") }}',
